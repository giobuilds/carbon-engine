...
# Usage: linux-tools/trinity_smoke.sh [stub|vulkan]   (after building trinity's x64-linux-debug-container preset)
set -euo pipefail
PLATFORM=${1:-stub}
...
TRINITY_PLATFORM=$PLATFORM BUILDFLAVOR=debug $EXEFILE /inherit /buildflavor=debug /py -m trinity_smoke"
