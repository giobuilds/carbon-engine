...
vcpkg_from_git(
  ...
  URL https://github.com/giobuilds/exefile.git
  REF 96fe96444f9d0c7e8709a815c36fa0f3f0e8586f
  HEAD_REF linux-port
)
...
if (DEFINED CARBON_BUILD_TYPE AND NOT CARBON_BUILD_TYPE MATCHES "Release")
  # The flavor postfix is lower-case (exefile_debug); only case-insensitive filesystems tolerated the mismatch.
  string(TOLOWER "${CARBON_BUILD_TYPE}" EXEFILE_FLAVOR)
  set(EXEFILE_TOOL ${EXEFILE_TOOL}_${EXEFILE_FLAVOR})
endif()
