function(ccp_prepare_interpreter)
    ...
    if (DEFINED arg_BUILD_TYPE AND NOT arg_BUILD_TYPE MATCHES "Release")
	    # The tool's flavor postfix is lower-case (exefile_debug); only case-insensitive filesystems forgave "Debug".
	    string(TOLOWER "${arg_BUILD_TYPE}" EXEFILE_FLAVOR)
	    set(EXEFILE_TOOL_NAME exefile_${EXEFILE_FLAVOR})
	else()
